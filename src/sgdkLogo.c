...
void displaySgdkLogo ()
{
    ...
    // Draw SEGA logo
    {
        ...
        drawImage(BG_A, &imgSGDKOutline, attr(PAL0), 14, 12, FALSE, TRUE);
        const u16 tileIndexLogoGradient1 = drawImage(BG_B, &imgSGDKGradient1, attr(PAL0), 14,  0, FALSE, TRUE);
        const u16 tileIndexLogoGradient0 = drawImage(BG_B, &imgSGDKGradient0, attr(PAL1), 14,  4, FALSE, TRUE);

        // Copy letters using different palettes
        VDP_setTileMapEx(BG_B, imgSGDKGradient1.tilemap, attr(PAL1)|tileIndexLogoGradient1, 14,  8, 0, 0, 12, 4, DMA);
        VDP_setTileMapEx(BG_B, imgSGDKGradient0.tilemap, attr(PAL2)|tileIndexLogoGradient0, 14, 12, 0, 0, 12, 4, DMA);
        VDP_setTileMapEx(BG_B, imgSGDKGradient1.tilemap, attr(PAL2)|tileIndexLogoGradient1, 14, 16, 0, 0, 12, 4, DMA);
        VDP_setTileMapEx(BG_B, imgSGDKGradient0.tilemap, attr(PAL3)|tileIndexLogoGradient0, 14, 20, 0, 0, 12, 4, DMA);
        VDP_setTileMapEx(BG_B, imgSGDKGradient1.tilemap, attr(PAL3)|tileIndexLogoGradient1, 14, 24, 0, 0, 12, 4, DMA);  
    }
